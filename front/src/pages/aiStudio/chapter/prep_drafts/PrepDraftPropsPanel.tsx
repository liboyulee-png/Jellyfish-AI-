...
export function PrepDraftPropsPanel({ projectId, chapterId, name, description }: Props) {
  ...
  const refreshAssetAndLink = async () => {
    ...
    try {
      ...
      const res = await StudioEntitiesApi.list('prop', {
        q: name,
        page: 1,
        pageSize: 100,
        order: null,
          ...
          <Button
            ...
            onClick={async () => {
              ...
              try {
                ...
                const created = await StudioEntitiesApi.create('prop', payload)
